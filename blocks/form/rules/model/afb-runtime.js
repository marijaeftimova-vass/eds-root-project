  ...
  updateDataNodeAndTypedValue(val) {
    ...
    if (changes.length > 0) {
      ...
      if (typeof dataNode !== 'undefined') {
        dataNode.setValue(this.getDataNodeValue(this._jsonModel.value),
            this._jsonModel.value, this);
      }
    }
    return changes;
  }
...
export {
  createFormInstance, fetchForm, registerFunctions,
  restoreFormInstance, validateFormData, validateFormInstance,
};
